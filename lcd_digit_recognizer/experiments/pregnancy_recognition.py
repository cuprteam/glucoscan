...
from recognize_seven_segment.experiments.detect_digits_freestyle_libre import detect_display_freestyle_libre, \
    detect_display_pregnancy_ellipsis
from recognize_seven_segment.utils.four_point_transform import four_point_transform

INPUT_PATH = "C:/Users/MiroslavVodolan/Desktop/Pregn/dataset"
OUTPUT_PATH = "C:/Users/MiroslavVodolan/Desktop/Pregn/output"
...
for filename in os.listdir(INPUT_PATH):
    ...
    output_path = os.path.join(OUTPUT_PATH, filename + ".png")
    ...
    # displays = [resized]
    start = time.time()
    displays = detect_display_pregnancy_ellipsis(resized, factor=scaling_factor)
    end = time.time()
